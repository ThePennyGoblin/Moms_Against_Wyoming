...
# Load the CSV files
batters_df = pd.read_csv('/mnt/data/Batters2.csv')
pitchers_df = pd.read_csv('/mnt/data/Pitchers2.csv')
injury_report_df = pd.read_csv('/mnt/data/injury_report_combined_years_v4.csv')
...
merged_filtered_df.to_csv('Merged_Filtered_Player_Data_2020_and_Later.csv', index=False)
